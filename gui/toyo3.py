# Form implementation generated from reading ui file 'toyo3.ui'
#
...
class Ui_toyo(object):
    def setupUi(self, toyo):
        ...
        self.txt_emp_name = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.txt_emp_name.setGeometry(QtCore.QRect(160, 10, 351, 61))
        self.txt_emp_name.setObjectName("txt_emp_name")
        self.txt_position = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.txt_position.setGeometry(QtCore.QRect(160, 90, 351, 61))
        self.txt_position.setObjectName("txt_position")
        self.txt_salary = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.txt_salary.setGeometry(QtCore.QRect(160, 160, 351, 61))
